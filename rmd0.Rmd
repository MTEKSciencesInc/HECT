...
where 
$$\sigma^2_2 = \frac{1}{n_2 + \frac{1}{\sigma_1^2}};$$
and 
$$\mu_2 = \sigma_2^2 \left(\frac{\mu_1}{\sigma^2_1}+n_2\bar{y}_{n_1:n_2,l}\right),$$
...
The updated posterior according to $n_2$ new patients with assignment vectors $\mathbf{x}_{n_1:n_2}$ and outcomes $y_{n_1:n_2}$, is given by
$$\theta_l \mid \mathbf{x}_{1:(n_1+n_2)}, y_{1:(n_1+n_2)}\sim Beta(a_1 + y_{n_1:n_2,l}, b_1 + n_2 - y_{n_1:n_2,l}),$$
where $y_{n_1:n_2,l}$ is the number of successes in arm $l$ among the new $n_2$ patients.
